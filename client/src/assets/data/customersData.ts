...
export const customerPoints: IPoints[] = [
  ...
  },
  {
    ...
    description: 'Зарабатывайте на росте или падении акций, валюты или сырья. Вы сами устанавливаете комфортный уровень защиты капитала и потенциальную доходность.',
  },
]